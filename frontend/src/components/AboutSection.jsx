import { timelineItems, valueCards } from '../data/about'
...
function TimelineItem({ item, isLast }) {
  return (
    <li className="flex gap-4 md:gap-6">
      ...
      <Card className="relative flex-1 rounded-xl border border-[#ffc300]/20 bg-[#111111]/70 p-5 backdrop-blur-[5px] md:p-8">
...
function ValueCard({ card }) {
  ...
  return (
    <Card className="rounded-2xl border border-[#ffc300]/20 bg-[#111111]/70 p-6 backdrop-blur-[5px] md:p-8">
...
export default function AboutSection() {
  return (
    <section id="about" className="px-5 py-16 md:px-10 md:py-20 lg:px-8 lg:py-[80px]">
      <Container className="flex max-w-[1024px] flex-col items-center gap-16 md:gap-20">
        <SectionHeading
          ...
          titleClassName="text-4xl font-bold leading-[1.15] md:text-5xl md:leading-[48px]"
          description={sectionCopy.aboutSubtitle}
          descriptionClassName="mx-auto mt-4 max-w-[672px] text-base leading-7 text-[#a3a3a3] md:text-[18px]"
        />
